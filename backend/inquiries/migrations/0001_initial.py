# Generated by Django 5.0.2 on 2024-03-19 06:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workFormat', models.TextField(choices=[('1', 'Полный день'), ('2', 'Гибридный формат'), ('3', 'Удаленная работа')], verbose_name='Формат работы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('citizenship', models.TextField(choices=[('1', 'РФ'), ('2', 'Не имеет значения')], verbose_name='гражданство')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentType', models.TextField(choices=[('1', '100% за выход сотрудника'), ('2', '50% за выход + 50% по окончании гарантийного периода (1-3 мес.)'), ('3', '100% по окончании гарантийного периода (1 мес.)')], verbose_name='тип оплаты')),
                ...
                ('resumeFormat', models.TextField(choices=[('1', 'Резюме без предварительного собеседования'), ('2', 'Резюме кандидатов, с которыми проведено интервью (с комментариями)')], verbose_name='Вид резюме')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='duties', to='inquiries.profession', verbose_name='профессия')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='prof_area',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inquiries.professionarea', verbose_name='профессиональная область'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=256, verbose_name='Навык')),
                ('profession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skills', to='inquiries.profession', verbose_name='профессия')),
            ],
            options={
                'verbose_name': 'Навык',
                'verbose_name_plural': 'Навыки',
